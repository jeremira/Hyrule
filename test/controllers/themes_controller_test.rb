...
class ThemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theme" do
    assert_difference('Theme.count') do
      post themes_url, params: { theme: { descr: @theme.descr, image: @theme.image, name: @theme.name } }
    end
  ...
  test "should update theme" do
    patch theme_url(@theme), params: { theme: { descr: @theme.descr, image: @theme.image, name: @theme.name } }
